...
public class FancySnowFlake extends AbstractShape {
	...
	public void draw(Graphics window) {
		...
		int[] xPoints = { x + hwh, x + hwq, x + hwe, x, x + hwe, x + hwq,
				x + hwh, x + hw / 2, x + hw, x + w - hw / 2, x + w - hwh,
				x + w - hwq, x + w - hwe, x + w, x + w - hwe, x + w - hwq,
				x + w - hwh, x + hw + hwq, x + hw, x + hw - hwq };
		int[] yPoints = { y + hh - hhe, y + hh - hhq, y + hh - hhe / 2, y + hh,
				y + hh + hhe / 2, y + hh + hhq, y + hh + hhe, y + h - hwq,
				y + h, y + h - hwq, y + hh + hhe, y + hh + hhq,
				y + hh + hhe / 2, y + hh, y + hh - hhe / 2, y + hh - hhq,
				y + hh - hhe / 2, y + hwq, y, y + hwq };
		int nPoints = 20;
