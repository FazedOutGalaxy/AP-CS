...
public class ArrayFunHouseRunner extends ApcsProject {
	...
	public void execute() {
		...
		printLine("sum of spots 3-6  =  "
				+ ArrayFunHouse.getSum(one, 3, 6));
		printLine("sum of spots 2-9  =  "
		...
		printLine("new array with all 7s removed  =  " + Arrays.toString(ArrayFunHouse.removeVal(one, 7)));
		printLine("# of 7s  =  " + ArrayFunHouse.getCount(one, 7));
		
		int[] two = { 4, 2, 3, 4, 6, 7, 8, 9, 0, 10, 0, 1, 7, 6, 5, 3, 2, 9, 9,
				8, 7 };
