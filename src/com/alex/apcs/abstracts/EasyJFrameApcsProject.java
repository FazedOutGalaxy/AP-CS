...
public abstract class EasyJFrameApcsProject extends EasyJFrame {
	
	public EasyJFrameApcsProject(String string) {
		super(string);
	}

	private static final long serialVersionUID = -580339004515428554L;

	public EasyJFrameApcsProject() {}
